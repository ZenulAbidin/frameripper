...
app.get('/projects', function (req, res) {
  ...
  if (!argv.testClient) {
    getProjects(db).then(function(projects) {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'endpoint', app_url: '/projects', app_request: 'get', app_status: 400, app_response: {'error': err.stack}});
...
app.put('/projects', function (req, res) {
  ...
  if (!argv.testClient) {
    setProjects(db, req.body.projects).then(value => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'endpoint', app_url: '/projects', app_request: 'put', app_status: 400, app_response: {'error': err.stack}});
      res.status(400).json({'error': err.toString()})
    })
  } else {
    logger.verbose({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'endpoint', app_url: '/projects', app_request: 'put', app_status: 200});
...
app.get('/currentproject', function (req, res) {
  ...
  if (!argv.testClient) {
    getCurrentProject(db).then(function(project) {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'endpoint', app_url: '/currentproject', app_request: 'get', app_status: 400, app_response: {'error': err.stack}});
      res.status(400).json({'error': err.toString()})
    })
  } else {
...
app.get('/currentsettings', function (req, res) {
  ...
  if (!argv.testClient) {
    var project = getCurrentProject(db).then(value => {
      console.log(value);
      return value;
    }).catch(function(err) {
...
app.get('/istranscodingjpgcomplete', function (req, res) {
  ...
  if (!argv.testClient) {
    isTranscodingJPGComplete().then(function(complete) {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'endpoint', app_url: '/istranscodingjpgcomplete', app_request: 'get', app_status: 400, app_response: {'error': err.stack}});
      res.status(400).json({'error': err.toString()})
    })
  } else {
    ticker_jpg += 1;
...
app.get('/istranscodingpngcomplete', function (req, res) {
  ...
  if (!argv.testClient) {
    isTranscodingPNGComplete().then(function(complete) {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'endpoint', app_url: '/istranscodingpngcomplete', app_request: 'get', app_status: 400, app_response: {'error': err.stack}});
      res.status(400).json({'error': err.toString()})
    })
  } else {
    ticker_png += 1;
...
const getProjects = db => {
  ...
  return new Promise((resolve, reject) => {
    db.get('/projects').then(value => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'get', app_key: '/projects', app_response: {success: false, 'error': err.stack}});
      reject(err);
    })
  })
}
...
const setProjects = (db, projects) => {
  ...
  return new Promise((resolve, reject) => {
    db.put('/projects', projects).then(value => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'set', app_key: '/projects', app_value: projects || default_null, app_response: {success: false, 'error': err.stack}});
      reject(err);
    })
  })
}
...
const getSettings = (db, project) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    var prefix = db.get('/project/'+project+'/prefix').then(value => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'get', app_key: '/project/'+project+'/prefix', app_response: {success: false, 'error': err.stack}});
      reject(err);
    })
    var frameOffset = db.get('/project/'+project+'/frameOffset').then((err, value) => {
      return value;
    }).catch(err => {
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'get', app_key: '/project/'+project+'/frameOffset', app_response: {success: false, 'error': err.stack}});
      reject(err);
    })
...
const setSettings = (db, project, prefix, frameOffset) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    db.put('/project/'+project+'/prefix', prefix).then(value => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'set', app_key: '/project/'+project+'/prefix', app_value: prefix || default_null, app_response: {success: false, 'error': err.stack}});
      reject(err);
    })
    db.put('/project/'+project+'/frameOffset', frameOffset).then((value) => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'set', app_key: '/project/'+project+'/frameOffset', app_value: frameOffset || default_null, app_response: {success: false, 'error': err.stack}});
      reject(err);
    })
  })
}
...
const getNumFrames = (db, project) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    var numFrames = db.get('/project/'+project+'/numFrames').then(value => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'get', app_key: '/project/'+project+'/numFrames', app_response: {success: false, 'error': err.stack}});
      reject(err);
    })
...
const setNumFrames = (db, project, numFrames) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    db.put('/project/'+project+'/numFrames', numFrames).then(value => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'set', app_key: '/project/'+project+'/numFrames', app_value: numFrames || default_null, app_response: {success: false, 'error': err.stack}});
      reject(err);
    })
  })
}
...
const getFramesList = (db, project) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    var framesList = db.get('/project/'+project+'/framesList').then(value => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'get', app_key: '/project/'+project+'/framesList', app_response: {success: false, 'error': err.stack}});
      reject(err);
    })
...
const setFramesList = (db, project, framesList) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    db.put('/project/'+project+'/framesList', framesList).then(value => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'set', app_key: '/project/'+project+'/framesList', app_value: framesList || default_null, app_response: {success: false, 'error': err.stack}});
      reject(err);
    })
  })
}
...
const deleteProject = (db, project) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    db.del('/project/'+project+'/prefix').then(value => {
      ...
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'del', app_key: '/project/'+project+'/prefix', app_response: {success: false, 'error': err.stack}});
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'del', app_key: '/project/'+project+'/frameOffset', app_response: {success: false, 'error': err.stack}});
      logger.error({time: moment().format("YYYY-MM-DDTHH:mm:ss.SSSSSSSSSZ"), app_subsystem: 'database', app_request: 'del', app_key: '/project/'+project+'/numFrames', app_response: {success: false, 'error': err.stack}});
